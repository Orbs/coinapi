...
// Inspiration from classtool
// https://github.com/gasteve/classtool
...
// Object.getPrototypeOf(module).defineClass = function(classConstructor) {
module.__proto__.defineClass = function(classConstructor) {
  ...
  function _createClass(bindings) {
    ...
    if(answer.superclass) {
      answer.inherit(answer.superclass);
    }
    return answer;
  }
  ...
  this.exports.find = function(name) {
